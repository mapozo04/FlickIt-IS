...
* **Funcionalidad de Deslizamiento de Productos:**
  * **Deslizamiento a la izquierda:** El producto se marca como "Me gusta" y se guarda en la sección de Compras.  
  * **Deslizamiento a la derecha:** El producto se descarta (No me gusta).  
...
* **Sistema de Recomendación Avanzado (Machine Learning):** Inicialmente, los productos se mostrarán por orden de subida o popularidad simple. Se desarrollarán algoritmos complejos de aprendizaje automático para la personalización de las recomendaciones.
...
| Manual de Usuario | Panel web para el uso de la plataforma para vendedores. | Equipo de Gestión |
...
* **Criterio 1: Deslizamiento Funcional:** El usuario puede deslizar productos a la derecha y a la izquierda, y la acción se registra correctamente.  
...
* **Criterio 4: Perfil y Ajustes Completos:** Todas las opciones dentro del apartado de Perfil (edición de datos, ajustes) son accesibles y permiten la modificación y guardado de la información.  
...
Pablo Díaz Ruipérez, Arturo González Carbajo y José Massot Gregorio. Revisado por Gabriel Vico Mata
