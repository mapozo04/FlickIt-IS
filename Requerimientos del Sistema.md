...
* **Gestión del Perfil:** El sistema debe permitir al usuario visualizar y editar su información personal (nombre, email) y configurar ajustes de privacidad e idioma.  
...
* **Usuario Final (Cliente):**  
  ...
  * Espera poder modificar sus datos personales de forma autónoma desde su perfil.  
